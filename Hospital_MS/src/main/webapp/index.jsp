	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="images/1_carousel.jpg" class="d-block w-100" alt="..."
					height="500px">
			</div>
			<div class="carousel-item">
				<img src="images/2_carousel.png" class="d-block w-100" alt="..."
					height="500px">
			</div>
			<div class="carousel-item">
				<img src="images/3_carousel.jpg" class="d-block w-100" alt="..."
					height="500px">
			</div>
		</div>
